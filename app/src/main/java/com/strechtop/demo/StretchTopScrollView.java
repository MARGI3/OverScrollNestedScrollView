...
public class StretchTopScrollView extends ScrollView implements OnScrollListener {
    ...
    public StretchTopScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public StretchTopScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
